...
const actions = {
    async fetchMachines({ commit }) {
      try {
        const response = await axios.get('http://localhost:8083/machines');
...
export const machines = [
    ...
    },
    {
      id: 2,
      name: 'Seated Dips',
      photo: 'gym-equipment-images/Seated Dips.jpg', 
      ...
      },
      {
        id: 4,
        name: 'Flat Bench',
        photo: 'gym-equipment-images/flat-bench.jpg', 
        description: "The bench press, a popular piece of gym equipment, is particularly suitable for beginners in weight lifting. The process involves lying flat on a padded bench and performing push-ups using a barbell. Positioned above the bench is a barbell stand to hold the barbell. The bench press offers support and also enables the use of dumbbells. Maintaining proper posture and a flat back while lifting the barbell while lying down is crucial to avoid any strain on your spine. Though a fundamental exercise, ensuring a correct form is essential to prevent any potential back injuries.",
        sets: '',
        reps: '',
        timeSlot: '',
        weightUsed: ''
      ...
      },
      {
        ...
        photo: 'gym-equipment-images/preacher-curl.jpg', 
        description: "To place special emphasis on building your biceps, you can engage in targeted exercises using a preacher curl bench. With this dedicated bench, you sit on a chair while your upper arms find support on an inclined surface in front of you. This setup allows you to perform bicep curls utilizing dumbbells, barbells, or alternative types of weights.",
        sets: '',
        reps: '',
        timeSlot: '',
        weightUsed: ''
      ...
      },
      {
        ...
        photo: 'gym-equipment/rotarytorso-.jpg',
        description: "This machine facilitates torso twisting to both sides, emphasizing the importance of utilizing your abdominal muscles for the twisting motion rather than relying on your hips or legs.",
        sets: '',
        reps: '',
        timeSlot: '',
        weightUsed: ''
      },
      {
        ...
        photo: 'gym-equipment/linear-leg-press.jpg',
        description: "Utilizing the leg press machine aids in enhancing leg definition without requiring a spotter's assistance. This machine involves pressing your legs upward against a weight-loaded platform while your back is supported by a low, padded seat. It offers a valuable addition to your fitness routine, complementing exercises such as squats and lunges.",
        sets: '',
        reps: '',
        timeSlot: '',
        weightUsed: ''
      ...
      },
      {
        ...
        photo: 'gym-equipment/leg-abduction.jpg',
        description: "The leg abduction and hip adduction machine provides resistance to your legs and hips while in a seated position. This exercise entails opening and closing your legs against weights. Notably, it targets and isolates your glutes and inner thigh muscles.",
        sets: '',
        reps: '',
        timeSlot: '',
        weightUsed: ''
      },
      {
        ...
        photo: 'gym-equipment/calf-raise-seated.jpg',
        description: "Utilizing the seated calf machine entails sitting on a seat, elevating your toes on a platform, and exerting pressure on the pads with your knees. This exercise effectively isolates and enhances the calf muscle, while also contributing to the strengthening of the ankle joint.",
        sets: '',
        reps: '',
        timeSlot: '',
        weightUsed: ''
      },
      {
        id: 21,
        name: 'Hack Squat ',
        photo: 'gym-equipment/hack-squat.jpg',
        description: "For added support during regular squats, the hack squat machine, also referred to as a squat rack, can be beneficial. This equipment enables better balance during squats and provides the option to incorporate more weight onto the power rack, effectively targeting and isolating your quadriceps.",
        sets: '',
        reps: '',
        timeSlot: '',
        weightUsed: ''
